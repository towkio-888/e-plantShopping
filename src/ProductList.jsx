...
function ProductList() {
    ...
    const handleAddToCart = (product) => {
        ...
        setAddedToCart((prevState) => ({
            ...prevState,
            [product.name]: true, // Indicate that the product is added to cart
        }));
    };
        ...
        },
        {
            ...
            plants: [
                ...
                },
                {
                    ...
                    description: "Heals wounds and reduces inflammation.",
                    cost: "$17"
                }
            ]
        }
    ...
    // Show plants when "Plants" link is clicked
    ...
    // Hide cart and continue shopping
